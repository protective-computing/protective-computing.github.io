...
\subsection{1.1 Research Foundation}\label{11-research-foundation}

This rubric is part of the Protective Computing corpus and should be
interpreted with the canonical structural paper:

Overton, K. (2026). \emph{Protective Computing Canon v1.0: A Structural
Map of the Discipline.} Protective Computing Community.
